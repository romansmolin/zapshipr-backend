...
class PostsService {
    ...
    async createPost(createPostsRequest, medias, userId) {
        try {
            ...
            const { postId } = await this.postRepository.createBasePost(userId, userId, // workspaceId - temporarily use userId
            initialStatus, createPostsRequest.postType, createPostsRequest.scheduledTime ?? null, createPostsRequest.mainCaption ?? null, createPostsRequest.coverTimestamp ?? null, coverImageUrl);
