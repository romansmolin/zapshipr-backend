...
(0, globals_1.describe)('InspirationsService', () => {
    ...
    let mockScheduler;
    let mockLogger;
    let mockContentParser;
    (0, globals_1.beforeEach)(() => {
        // Mock repository
        mockRepository = {
            create: globals_1.jest.fn(),
            findById: globals_1.jest.fn(),
            findByIdWithExtraction: globals_1.jest.fn(),
            findByWorkspaceId: globals_1.jest.fn(),
            findByWorkspaceIdWithExtraction: globals_1.jest.fn(),
        ...
        mockContentParser = {
            parseUrl: globals_1.jest.fn(),
            parseDocument: globals_1.jest.fn(),
            extractVideoMetadata: globals_1.jest.fn(),
            normalizeContent: globals_1.jest.fn(),
        };
        // Mock logger
        mockLogger = {
        ...
        service = new inspirations_service_1.InspirationsService(mockRepository, mockMediaUploader, mockScheduler, mockContentParser, mockLogger);
    });
    ...
    (0, globals_1.describe)('getInspirations', () => {
        (0, globals_1.it)('should return inspirations list with pagination', async () => {
            ...
            (0, globals_1.expect)(mockRepository.findByWorkspaceIdWithExtraction).toHaveBeenCalledWith('ws-1', { limit: 20, offset: 0 });
        });
    ...
    (0, globals_1.describe)('getInspirationById', () => {
        (0, globals_1.it)('should return inspiration by id', async () => {
            ...
            (0, globals_1.expect)(result).toEqual(mockInspiration);
            (0, globals_1.expect)(mockRepository.findByIdWithExtraction).toHaveBeenCalledWith('123');
        });
    ...
    (0, globals_1.describe)('updateInspiration', () => {
        ...
        (0, globals_1.it)('should throw error if inspiration not found', async () => {
            ...
            await (0, globals_1.expect)(service.updateInspiration('nonexistent', 'ws-1', 'New description')).rejects.toThrow(app_error_1.AppError);
            await (0, globals_1.expect)(service.updateInspiration('nonexistent', 'ws-1', 'New description')).rejects.toMatchObject({
    ...
    (0, globals_1.describe)('deleteInspiration', () => {
        ...
        (0, globals_1.it)('should throw error if inspiration not found', async () => {
            mockRepository.findById.mockResolvedValue(undefined);
            await (0, globals_1.expect)(service.deleteInspiration('nonexistent', 'ws-1')).rejects.toThrow(app_error_1.AppError);
            await (0, globals_1.expect)(service.deleteInspiration('nonexistent', 'ws-1')).rejects.toMatchObject({
                errorMessageCode: app_error_1.ErrorMessageCode.INSPIRATION_NOT_FOUND,
                httpCode: 404,
            });
        });
