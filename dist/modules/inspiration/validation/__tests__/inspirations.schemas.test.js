...
(0, globals_1.describe)('Inspirations Validation Schemas', () => {
    (0, globals_1.describe)('CreateInspirationSchema', () => {
        ...
        (0, globals_1.it)('should accept valid inspiration types', () => {
            ...
            types.forEach((type) => {
                const result = inspirations_schemas_1.CreateInspirationSchema.safeParse({ type, title: 'Test title' });
                (0, globals_1.expect)(result.success).toBe(true);
            });
        });
    ...
    (0, globals_1.describe)('validateInspirationByType', () => {
        ...
        (0, globals_1.it)('should reject tiktok links', () => {
            (0, globals_1.expect)(() => {
                (0, inspirations_schemas_1.validateInspirationByType)({
                    type: 'link',
                    content: 'https://www.tiktok.com/@user/video/1234567890',
                });
            }).toThrow('TikTok links are not supported yet');
        });
        (0, globals_1.it)('should reject instagram reels links', () => {
            (0, globals_1.expect)(() => {
                (0, inspirations_schemas_1.validateInspirationByType)({
                    type: 'link',
