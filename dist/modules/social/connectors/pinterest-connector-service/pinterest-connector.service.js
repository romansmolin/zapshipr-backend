...
class PinterestConnectorService {
    ...
    async connectPinterestAccount(userId, code) {
        try {
            ...
            const account = new account_1.Account((0, uuid_1.v4)(), userId, "pinterest", profileResponse.username, accessToken, new Date(), profileResponse.id, accountImageUrl, tokenResponse.refresh_token);
