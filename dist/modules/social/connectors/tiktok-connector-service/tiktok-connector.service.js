...
class TikTokConnectorService {
    ...
    async connectTikTokAccount(userId, code) {
        try {
            ...
            const account = new account_1.Account((0, uuid_1.v4)(), userId, "tiktok", user.display_name, accessToken, new Date(), user.open_id, userAvatar, refresh_token, tokenExpiresIn, refreshTokenExpiresIn, creatorInfo.maxVideoPostDurationSec, creatorInfo.privacyLevelOptions);
