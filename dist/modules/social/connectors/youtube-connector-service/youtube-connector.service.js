...
class YouTubeConnectorService {
    ...
    async connectYouTubeAccount(userId, code) {
        try {
            ...
            const account = new account_1.Account((0, uuid_1.v4)(), userId, "youtube", channel.snippet.title, accessToken, new Date(), channel.id, accountImageUrl, refreshToken, tokenExpiresIn, refreshTokenExpiresIn);
