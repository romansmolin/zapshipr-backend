CREATE TABLE "workspace_profile_signals" (
	...
	"weight" numeric(3, 2) DEFAULT '1.0' CHECK ("weight" >= 0.0 AND "weight" <= 1.0),
...
CREATE INDEX "workspace_signals_created_idx" ON "workspace_profile_signals" USING btree ("created_at" DESC);
