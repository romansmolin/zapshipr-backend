...
import { NodemailerEmailService } from '@/modules/email/services/email/email.service'
...
import { WorkspaceProfileService } from '@/modules/workspace/services/workspace-profile/workspace-profile.service'
import { WorkspaceTagsService } from '@/modules/inspiration/services/workspace-tags/workspace-tags.service'
import { WorkspaceService } from '@/modules/workspace/services/workspace/workspace.service'
import { SocialMediaPublisherFactory } from '@/modules/social/factories/socia-media-publisher.factory'
import { SocialMediaPostSenderService } from '@/modules/social/services/social-media-post-sender/social-media-post-sender.service'
import { SocialMediaTokenRefresherService } from '@/modules/social/services/social-media-token-refresher/social-media-token-refresher.service'
import { PostsService } from '@/modules/post/services/posts/posts.service'
import { PostMediaService } from '@/modules/post/services/post-media/post-media.service'
import { PostSchedulingService } from '@/modules/post/services/post-scheduling/post-scheduling.service'
import { InspirationsService } from '@/modules/inspiration/services/inspirations/inspirations.service'
import { ContentParserService } from '@/modules/inspiration/services/content-parser/content-parser.service'
import { MediaService } from '@/modules/media/services/media/media.service'
import { BillingService } from '@/modules/billing/services/billing/billing.service'
import { AuthService } from '@/modules/auth/services/auth/auth.service'
import { WaitlistService } from '@/modules/waitlist/services/waitlist/waitlist.service'
import { AccountsService } from '@/modules/social/services/accounts/accounts.service'
import { SocilaMediaConnectorService } from '@/modules/social/services/social-media-connector/social-media-connector.service'
import { OAuthStateService } from '@/modules/social/services/oauth-state/oauth-state.service'
import { AiService } from '@/modules/ai/services/ai/ai.service'
...
import type { IAuthService } from '@/modules/auth/services/auth/auth-service.interface'
...
import type { IWorkspaceService } from '@/modules/workspace/services/workspace/workspace-service.interface'
...
import type { IInspirationsService } from '@/modules/inspiration/services/inspirations/inspirations-service.interface'
import type { IMediaService } from '@/modules/media/services/media/media-service.interface'
